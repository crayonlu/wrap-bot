...
var configDescriptions = map[string]string{
	...
	"AI_KEY":                "AI API 密钥",
	"AI_MODEL":              "AI 模型名称",
	"AI_TOOLS_ENABLED":      "是否启用 AI 工具调用功能",
	...
	"AI_TEXT_MODEL":         "Text 模型名称",
	"AI_VISION_MODEL":       "Vision 模型名称",
	"AI_TEMPERATURE":        "AI 温度参数",
	"AI_TOP_P":              "AI TopP 参数",
	"AI_MAX_TOKENS":         "AI 最大 Token 数",
	"AI_MAX_HISTORY":        "AI 最大历史记录数",
	"SERP_API_KEY":          "SerpAPI 密钥（网络搜索）",
	"WEATHER_API_KEY":       "WeatherAPI 密钥（天气查询）",
	"AI_TEXT_MODEL_TOOLS":   "Text 模型启用的工具（逗号分隔）",
	"AI_VISION_MODEL_TOOLS": "Vision 模型启用的工具（逗号分隔）",
}
