...
func NewClient(apiURL, apiKey, model, systemPromptPath string) *Client {
...
func (ai *Client) Chat(conversationID, userMessage string, addToHistory bool) (string, error) {
	...
	if len(choice.Message.ToolCalls) > 0 {
		return ai.handleToolCalls(conversationID, choice.Message, addToHistory)
	}
...
func (ai *Client) handleToolCalls(conversationID string, assistantMsg Message, addToHistory bool) (string, error) {
	if addToHistory {
		ai.history.Add(conversationID, assistantMsg)
	}
...
func (ai *Client) executeFunction(name, argsJSON string) string {
	switch name {
...
func (ai *Client) ClearHistory(conversationID string) {
...
func Chat(prompt string, addToHistory bool) (string, error) {
	if globalClient == nil {
		return "", fmt.Errorf("AI client not initialized")
	}
	return globalClient.Chat("plugin_call", prompt, addToHistory)
}
